var card =
  ...
  '          <div class="clmn_9"><input type="text" class="id" value="a@a.com" readonly/><button class="btn btn-mini"><i class="fas fa-clipboard"></i></button></div>' +
  "        </div>" +
  '        <div class="row">' +
  '          <div class="clmn_1">PW</div>' +
  '          <div class="clmn_9"><input type="text" class="pw" value="asdfqwer" readonly/><button class="btn btn-mini"><i class="fas fa-clipboard"></i></button></div>' +
  "        </div>" +
  "      </div>";
