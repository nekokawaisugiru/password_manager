var card =
  ...
  '          <div class="clmn_9"><input type="text" class="pw" value="" onfocus="this.select();" readonly/><button class="btn btn-mini clip_board"><i class="fas fa-clipboard"></i></button></div>' +
  "        </div>" +
